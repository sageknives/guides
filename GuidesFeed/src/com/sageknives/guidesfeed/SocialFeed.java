package com.sageknives.guidesfeed;
...
public class SocialFeed extends FragmentActivity implements
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.social_feed, menu);
		return true;
	}
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.title_world).toUpperCase(l);
			case 1:
				return getString(R.string.title_my_feed).toUpperCase(l);
			case 2:
